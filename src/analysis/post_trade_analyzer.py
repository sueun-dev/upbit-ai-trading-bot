...
class PostTradeAnalyzer:
    ...
    def _calculate_trade_metrics(
        ...
        price_metrics = self._calculate_price_metrics(entry_price, exit_price, quantity)
    ...
    def _calculate_price_metrics(
        ...
        return {"loss_percentage": loss_percentage, "loss_amount": loss_amount}
    ...
    def _assess_market_sentiment(self, market_data: Dict[str, Any]) -> str:
        ...
        if (
            price_change < PANIC_SELLING_PRICE_THRESHOLD
            and volume_ratio > PANIC_SELLING_VOLUME_THRESHOLD
        ):
    ...
    def _check_support_breach(self, symbol: str, market_data: Dict[str, Any]) -> bool:
        ...
        return bool(current_price < low_24h * SUPPORT_BREACH_THRESHOLD)
...
decision_quality, warning_signs, avoidable, key_lesson"""
    ...
    def _get_market_condition_lessons(
    ...
    def _get_timing_lessons(self, trade_metrics: Dict[str, Any]) -> List[str]:
        ...
        if trade_metrics["hold_duration_hours"] < QUICK_LOSS_HOURS:
            lessons.append(
                "Quick losses suggest poor entry timing - improve entry analysis"
            )
        return lessons
    ...
    def _prepare_outcome_data(
        self, symbol: str, trade_metrics: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _generate_future_recommendations(
        self, severity: str, lessons: List[str]
    ) -> List[str]:
    ...
    def _build_stop_loss_analysis_result(
        ...
        return {
            ...
            "recommendations": self._generate_future_recommendations(severity, lessons),
        }
